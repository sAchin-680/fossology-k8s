...
{{- printf "%s/fossology/fossology:%s" .Values.image.registry .Values.image.tag }}
{{- else -}}
{{- printf "fossology/fossology:%s" .Values.image.tag }}
{{- end }}
{{- end }}
...
{{- printf "%s/fossology-worker:%s" .Values.image.registry .Values.image.tag }}
{{- else -}}
{{- printf "fossology-worker:%s" .Values.image.tag }}
{{- end }}
{{- end }}
